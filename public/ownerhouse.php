...
$sqlQueryHouse = "SELECT * FROM house {$order} WHERE ownerId = '{$_SESSION['userid']}' LIMIT 8";
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-5">
                        ...
                        <div class="popular-proparty">
                            ...
                            <div class="popular-proparty-item border border-0 d-flex">
                                <div class="img-circle rounded-circle"></div>
                                <div class="popular-proparty-item-text">
                                    <h5>Lorem ipsum dolor sit</h5>
                                    <div class="d-flex">
